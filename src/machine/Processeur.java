...
public class Processeur {
	...
	public abstract class Instruct{
		...
		protected Memoire memoire(){ return memoire;}
		protected int e1(){ return e1;}
		protected int e2(){ return e2;}
	}
	/**
//	 * 
//	 * @return la prochaine adresse Ã  exÃ©cuter pour ce processus, -1 si mort
//	 */
//	public int execute(){
...
//		registreInstruction.op2().valeur(adresseEffective(registreInstruction.op1()) + adresseEffective(registreInstruction.op2()));
//		compteurOrdinal++;
//	}
//	
//	/**
...
//	}
	...
	private int adresseEffective(Operande op){
		// adressage relatif
		if(op.adressage().symbole().equals("$") || op.adressage().symbole().equals(""))
		...
		// adressage relatif indirect
			...
			return compteurOrdinal+memoire.instruction(compteurOrdinal+op.valeur()).op2().valeur();
		}
		return 0;
	}
}